...
lib.init = function(title, accent, togglekey)
	...
	lib.title = title or "Octel"
	lib.accent = accent or lib.accent
	lib.togglekey = togglekey or Enum.KeyCode.RightShift
	lib.flags = {}
	lib.selectedtab = nil
	...
	uiNameLabel.Font = Enum.Font.Code
	...
	window.createTab = function(title, image)
		...
		uiTabButtonLabel.Font = Enum.Font.Code
		...
		tab.createSection = function(title)
			...
			uiTabSectionLabel.Font = Enum.Font.Code
			...
			things.createToggle = function(title, default, flag, callback)
				...
				uiButtonLabel.Font = Enum.Font.Code
			...
			things.createSlider = function(title, default, min, max, suffix, flag, callback)
				...
				uiSliderLabel.Font = Enum.Font.Code
			...
			things.createColorpicker = function(title, default, addon, flag, callback)
				...
				uiColorClose.Font = Enum.Font.CodeBold
				uiColorClose.Text = "X"
				...
				uiColorLabel.Font = Enum.Font.Code
			...
			things.createDropdown = function(title, options, flag, callback)
				...
				uiDropdownLabel.Font = Enum.Font.Code
				...
				uiSliderSelectionsLabel.Font = Enum.Font.Code
				...
				for i,v in pairs(options) do
					...
					uiSliderSelection.Font = Enum.Font.Code
